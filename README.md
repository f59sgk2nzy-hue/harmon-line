...
Open [http://localhost:43173](http://localhost:43173). The home board defaults to **today's games in US/Eastern**. Click any game for a detail page with scoring, leaders, and play-by-play when ESPN publishes it. **Rankings** (/rankings) lists AP, Coaches, FCS, D2, and D3 polls from the same public ESPN JSON. From a game or team page, open **DEEP DIVE / SIM** for matchup stats, a labeled Monte Carlo simulation, and prop-feedback cards.
