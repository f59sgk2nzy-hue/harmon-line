...
export const metadata: Metadata = {
  ...
  description:
    "Natural-language situational Q&A over public ESPN scoreboard and summary JSON. Evidence vs inference. Scores are never invented.",
};
...
export default async function OraclePage({
  ...
  return (
    <>
      ...
      />
      <PageTransition>
        <OracleView league={league} query={query} data={data} />
      </PageTransition>
    </>
  );
}
